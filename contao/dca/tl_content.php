...
use JedoCodes\AnimateOnScrollBundle\EventListener\DataContainer\ContentFieldsListener;
...
foreach ($GLOBALS['TL_DCA']['tl_content']['palettes'] as $key => $palette) {
    ...
    if (is_string($key)) {
        PaletteManipulator::create()
            ...
            ->addField('aosAnimationneffects', 'aos_legend', PaletteManipulator::POSITION_APPEND)
...
$GLOBALS['TL_DCA']['tl_content']['fields']['aosAnimationneffects'] = [
    'exclude' => true,
    'inputType' => 'checkbox',
